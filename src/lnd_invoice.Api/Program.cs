...
{
    //Price in btc
    var priceInBitcoin = await rateService.GetBitcoinPrice(invoice.Currency, invoice.Amount);
...
{
    //PROD
    //var invoice = await lndService.IsPaid(System.Uri.EscapeDataString(r_hash_str));
